...
public class ZenMoneyClient(
    IOptions<ZenMoneyConfiguration> config,
    ILogger<ZenMoneyClient> logger,
    IHttpRequestBuilder httRequestBuilder)
{
    ...
    {
        var cookie = config.Value.Cookie;
        if (string.IsNullOrWhiteSpace(cookie))
        {
            throw new InvalidOperationException("Cookie is not provided");
        }
